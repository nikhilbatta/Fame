...
namespace Fame
{
    public class Situation
    {
        ...
        public static string GenerateRandCeleb(string lastCeleb)
        {
            List<string> celebrityKeys = new List<string>(CelebrityFunctions.Keys);

            Random rand = new Random();
            int randomNum = rand.Next(0,celebrityKeys.Count);  

            string randomCelebrity = celebrityKeys[randomNum];
            if(randomCelebrity == lastCeleb)
            {
                return GenerateRandCeleb(lastCeleb);
            }
            else
            {
            ...
            if(answer1 == "y" || answer1 =="Y")
            {
                ...
                if(answer2 == "T" || answer2 == "t")
                {
                    Console.WriteLine("You introduce yourself like a normal person. He ends up talking to him for hours because it's been so long since someone has been so nice to him. Papparazzi take loads of pics and his die hard fans go after your followers! Lose 175 followers.");
                     ...
                     Program.HollywoodAdventure(userCeleb, "Tom Cruise");
        ...
        public static void WizKhalifa(Celebrity userCeleb)
        {
            ...
            if(answer1 == "y" || answer1 =="Y")
            {
                ...
                {                   
                   ...
                   Program.HollywoodAdventure(userCeleb, "Wiz Khalifa");
        ...
        public static void ElijahWood(Celebrity userCeleb)
        {
            ...
            if(answer1 == "y" || answer1 =="Y")
            {
                ...
                {                   
                   ...
                   Program.HollywoodAdventure(userCeleb, "Elijah Wood");
       ...
       public static void JeffProbst(Celebrity userCeleb)
        {
            ...
            if(answer1 == "y" || answer1 =="Y")
            {
                ...
                {                   
                   ...
                   Program.HollywoodAdventure(userCeleb, "Jeff Probst");
        ...
        public static void JeffGoldblum(Celebrity userCeleb)
        {
            ...
            if(answer1 == "y" || answer1 =="Y")
            {
                ...
                {                   
                   ...
                   Program.HollywoodAdventure(userCeleb, "Jeff Goldblum");
